...
### AgentRegistryV2$Data
TL-B: `_ owner:address settlementContract:address totalNodes:uint64 activeNodes:uint64 totalTasksCompleted:uint64 genesisVersion:uint32 genesisManifestHash:uint256 edgeCount:uint64 cpuCount:uint64 gpuCount:uint64 headCount:uint64 registeredNodes:dict<int, bool> nodeAddresses:dict<int, address> = AgentRegistryV2`
Signature: `AgentRegistryV2{owner:address,settlementContract:address,totalNodes:uint64,activeNodes:uint64,totalTasksCompleted:uint64,genesisVersion:uint32,genesisManifestHash:uint256,edgeCount:uint64,cpuCount:uint64,gpuCount:uint64,headCount:uint64,registeredNodes:dict<int, bool>,nodeAddresses:dict<int, address>}`
...
graph TD
AgentRegistryV2
AgentRegistryV2 --> BaseTrait
AgentRegistryV2 --> Deployable
Deployable --> BaseTrait
AgentRegistryV2 --> Ownable
Ownable --> BaseTrait
```
