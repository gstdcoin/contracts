...
export type AgentRegistryV2$Data = {
    $$type: 'AgentRegistryV2$Data';
    owner: Address;
    ...
    nodeAddresses: Dictionary<bigint, Address>;
}

export function storeAgentRegistryV2$Data(src: AgentRegistryV2$Data) {
    return (builder: Builder) => {
        const b_0 = builder;
        ...
        b_1.storeDict(src.nodeAddresses, Dictionary.Keys.BigInt(257), Dictionary.Values.Address());
        b_0.storeRef(b_1.endCell());
    };
}

export function loadAgentRegistryV2$Data(slice: Slice) {
    const sc_0 = slice;
    ...
    const _nodeAddresses = Dictionary.load(Dictionary.Keys.BigInt(257), Dictionary.Values.Address(), sc_1);
    return { $$type: 'AgentRegistryV2$Data' as const, owner: _owner, settlementContract: _settlementContract, totalNodes: _totalNodes, activeNodes: _activeNodes, totalTasksCompleted: _totalTasksCompleted, genesisVersion: _genesisVersion, genesisManifestHash: _genesisManifestHash, edgeCount: _edgeCount, cpuCount: _cpuCount, gpuCount: _gpuCount, headCount: _headCount, registeredNodes: _registeredNodes, nodeAddresses: _nodeAddresses };
}

export function loadTupleAgentRegistryV2$Data(source: TupleReader) {
    ...
    const _nodeAddresses = Dictionary.loadDirect(Dictionary.Keys.BigInt(257), Dictionary.Values.Address(), source.readCellOpt());
    return { $$type: 'AgentRegistryV2$Data' as const, owner: _owner, settlementContract: _settlementContract, totalNodes: _totalNodes, activeNodes: _activeNodes, totalTasksCompleted: _totalTasksCompleted, genesisVersion: _genesisVersion, genesisManifestHash: _genesisManifestHash, edgeCount: _edgeCount, cpuCount: _cpuCount, gpuCount: _gpuCount, headCount: _headCount, registeredNodes: _registeredNodes, nodeAddresses: _nodeAddresses };
}

export function loadGetterTupleAgentRegistryV2$Data(source: TupleReader) {
    const _owner = source.readAddress();
    const _settlementContract = source.readAddress();
    const _totalNodes = source.readBigNumber();
    const _activeNodes = source.readBigNumber();
...
export function storeTupleAgentRegistryV2$Data(source: AgentRegistryV2$Data) {
    const builder = new TupleBuilder();
    ...
    builder.writeCell(source.nodeAddresses.size > 0 ? beginCell().storeDictDirect(source.nodeAddresses, Dictionary.Keys.BigInt(257), Dictionary.Values.Address()).endCell() : null);
    return builder.build();
}

export function dictValueParserAgentRegistryV2$Data(): DictionaryValue<AgentRegistryV2$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeAgentRegistryV2$Data(src)).endCell());
        },
        parse: (src) => {
            return loadAgentRegistryV2$Data(src.loadRef().beginParse());
        }
    }
}
...
export function dictValueParserNodeInfo(): DictionaryValue<NodeInfo> {
 ...
 type AgentRegistryV2_init_args = {
    $$type: 'AgentRegistryV2_init_args';
    owner: Address;
    settlement: Address;
}

function initAgentRegistryV2_init_args(src: AgentRegistryV2_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeAddress(src.owner);
        b_0.storeAddress(src.settlement);
    };
}

async function AgentRegistryV2_init(owner: Address, settlement: Address) {
    const __code = Cell.fromHex('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initAgentRegistryV2_init_args({ $$type: 'AgentRegistryV2_init_args', owner, settlement })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

export const AgentRegistryV2_errors = {
...
export const AgentRegistryV2_errors_backward = {
    "Stack underflow": 2,
    "Stack overflow": 3,
    "Integer overflow": 4,
...
const AgentRegistryV2_types: ABIType[] = [
...
const AgentRegistryV2_getters: ABIGetter[] = [
    {"name":"get_network_stats","methodId":125087,"arguments":[],"returnType":{"kind":"simple","type":"NetworkStats","optional":false}},
    {"name":"get_genesis_manifest","methodId":79434,"arguments":[],"returnType":{"kind":"simple","type":"GenesisManifestData","optional":false}},
    {"name":"get_node_address","methodId":103171,"arguments":[{"name":"nodeId","type":{"kind":"simple","type":"int","optional":false,"format":257}}],"returnType":{"kind":"simple","type":"address","optional":false}},
    {"name":"owner","methodId":83229,"arguments":[],"returnType":{"kind":"simple","type":"address","optional":false}},
]

export const AgentRegistryV2_getterMapping: { [key: string]: string } = {
    'get_network_stats': 'getGetNetworkStats',
    'get_genesis_manifest': 'getGetGenesisManifest',
    'get_node_address': 'getGetNodeAddress',
    'owner': 'getOwner',
}

const AgentRegistryV2_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"typed","type":"RegisterNode"}},
    {"receiver":"internal","message":{"kind":"typed","type":"UpdateReputation"}},
    {"receiver":"internal","message":{"kind":"typed","type":"ReportGenesisViolation"}},
    {"receiver":"internal","message":{"kind":"typed","type":"SetGenesisManifest"}},
    {"receiver":"internal","message":{"kind":"typed","type":"Deploy"}},
]


export class AgentRegistryV2 implements Contract {
    
    public static readonly storageReserve = 0n;
    public static readonly errors = AgentRegistryV2_errors_backward;
    public static readonly opcodes = AgentRegistryV2_opcodes;
    
    static async init(owner: Address, settlement: Address) {
        return await AgentRegistryV2_init(owner, settlement);
    }
    
    static async fromInit(owner: Address, settlement: Address) {
        const __gen_init = await AgentRegistryV2_init(owner, settlement);
        const address = contractAddress(0, __gen_init);
        return new AgentRegistryV2(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new AgentRegistryV2(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  AgentRegistryV2_types,
        getters: AgentRegistryV2_getters,
        receivers: AgentRegistryV2_receivers,
        errors: AgentRegistryV2_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: RegisterNode | UpdateReputation | ReportGenesisViolation | SetGenesisManifest | Deploy) {
        ...
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'ReportGenesisViolation') {
            body = beginCell().store(storeReportGenesisViolation(message)).endCell();
        }
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'SetGenesisManifest') {
            body = beginCell().store(storeSetGenesisManifest(message)).endCell();
        }
    ...
    async getGetNetworkStats(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get('get_network_stats', builder.build())).stack;
        const result = loadGetterTupleNetworkStats(source);
        return result;
    }
    
    async getGetGenesisManifest(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get('get_genesis_manifest', builder.build())).stack;
        const result = loadGetterTupleGenesisManifestData(source);
        return result;
    }
    
    async getGetNodeAddress(provider: ContractProvider, nodeId: bigint) {
        const builder = new TupleBuilder();
        builder.writeNumber(nodeId);
        const source = (await provider.get('get_node_address', builder.build())).stack;
