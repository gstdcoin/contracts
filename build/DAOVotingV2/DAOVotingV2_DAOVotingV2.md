...
TL-B: `update_governance_params#ff7e179e quorumPercent:uint8 timelockSeconds:uint32 quorumStakeTon:coins = UpdateGovernanceParams`
Signature: `UpdateGovernanceParams{quorumPercent:uint8,timelockSeconds:uint32,quorumStakeTon:coins}`

### DAOVotingV2$Data
TL-B: `_ owner:address gstdJetton:address quorumPercent:uint8 timelockSeconds:uint32 quorumStakeTon:coins totalStakedGSTD:coins proposalCount:uint64 executedCount:uint64 cancelledCount:uint64 proposalAddresses:dict<int, address> = DAOVotingV2`
Signature: `DAOVotingV2{owner:address,gstdJetton:address,quorumPercent:uint8,timelockSeconds:uint32,quorumStakeTon:coins,totalStakedGSTD:coins,proposalCount:uint64,executedCount:uint64,cancelledCount:uint64,proposalAddresses:dict<int, address>}`
...
### GovernanceStats
TL-B: `_ proposalCount:uint64 executedCount:uint64 cancelledCount:uint64 quorumPercent:uint8 timelockSeconds:uint32 quorumStakeTon:coins totalStakedGSTD:coins = GovernanceStats`
Signature: `GovernanceStats{proposalCount:uint64,executedCount:uint64,cancelledCount:uint64,quorumPercent:uint8,timelockSeconds:uint32,quorumStakeTon:coins,totalStakedGSTD:coins}`
...
* 54682: Quorum stake must be positive
...
graph TD
DAOVotingV2
DAOVotingV2 --> BaseTrait
DAOVotingV2 --> Deployable
