...
### SetConvertRatio
TL-B: `set_convert_ratio#def20831 ratio:uint8 = SetConvertRatio`
Signature: `SetConvertRatio{ratio:uint8}`

### SetDexRouter
TL-B: `set_dex_router#a101de29 router:address = SetDexRouter`
Signature: `SetDexRouter{router:address}`
...
graph TD
TreasuryGold
TreasuryGold --> BaseTrait
TreasuryGold --> Deployable
Deployable --> BaseTrait
TreasuryGold --> Ownable
Ownable --> BaseTrait
```
